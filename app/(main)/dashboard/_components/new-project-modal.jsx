...
const NewProjectModal = ({ isOpen, onClose }) => {
    ...
    const handleCreateProject = async () => {
        if (!canCreate) {
            toast.error("Free plan is limited to 5 projects. Upgrade to Pro for unlimited projects.");
            return;
        }
    ...
    useEffect(() => {
        if (isFree && currentProjectCount >= PROJECT_LIMIT) {
            toast.error("Free plan is limited to 5 projects. Please upgrade to Pro.");
        }
